                        ...
                        <div className="col">
                            <div className="widget widget_text">
                                <div className="textwidget">
                                    <p>
                                        <img src="assets/img/logo-small@2x.png" alt="imagealt" width={170} height={34} />
                                    </p>
                                    <p className="margin-bottom-15">Development Services of America inc is a wholly owned subsidiary of Services Group of America</p>
                                    <ul>
                                        <li>
                                            <div className="inner">
                                                <span className="fa fa-map-marker" />
                                                <span className="text">16100 N 71st St #520, Scottsdale, AZ 85254</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="inner">
                                                <span className="fa fa-phone" />
                                                <span className="text">CALL US : (480)927-4888</span>
                                            </div>
                                        </li>
                                        <li className="margin-top-7">
                                            <div className="inner">
                                                <span className=" font-size-14 fa fa-envelope" />
                                                <span className="text">EMAIL@DSA.com</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
